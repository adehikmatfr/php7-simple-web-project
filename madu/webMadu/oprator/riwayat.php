...
<section>
      ...
      <li>
          <a class="nav-link text-warning" href="riwayat.php">Riwayat</a>
      </li>
       <li>
...
<form action="" method="post">
   ...
   <?php $a++; endwhile; ?>
            ...
            <div class="col-lg-3 mt-2">
              <button type="submit" name="cari" class="btn btn-primary btn-block mt-4" <?=$dis?>>Cari</button>
            </div>
           </div>
</form>
...
<!-- tabel -->
        <h3 class="mt-3 mb-2">Data Riwayat Panen <?=$ex[1]?></h3> 
...
$row=tampil($str);
 ?>
<div class="container-fluid bg-dark" style="max-width: 100%; height:220px; margin-top: 200px;"> 
